    ...
    def __init__(self, input_size, interpolation=cv2.INTER_LINEAR):
        ...
        self.transform_fn = A.Compose([
            A.Lambda(name="FitResize",
                     ...
                     always_apply=True,
                     p=1.0),
            A.CLAHE(clip_limit=(4,4), tile_grid_size=(32, 32), always_apply=True, p=1.0),
...
class Exp(_BaseExp):
    ...
    def __init__(self, args):
        ...
        self.meta = {
            'csv_root_dir': '/home/dangnh36/datasets/.comp/rsna/cv/v2/',
            # 'img_root_dir': '/home/dangnh36/datasets/.comp/rsna/crops/uint8_voilut_png@yolox_nano_bre_416_datav2',
            'img_root_dir':
            '/raid/.comp/rsna/uint8_voilut_png@yolox_nano_bre_416_datav2',
            'fold_idx': 0,
            'num_sched_epochs': 6,
            'num_epochs': 50,
            'start_ratio': 1 / 3,
    ...
    def build_train_dataset(self):
        ...
        train_dataset = datasets.v2.RSNADataset(csv_path, img_root_dir,
                                                augment_fn, transform_fn, n_channels=self.args.input_size[0], subset = 'train')
    ...
    def build_val_dataset(self):
        ...
        print('Val Transform:\n', transform_fn)
        val_dataset = datasets.v2.RSNADataset(csv_path, img_root_dir,
                                              augment_fn, transform_fn, n_channels= self.args.input_size[0], subset = 'val')
        return val_dataset
