...
class Exp(_BaseExp):
    ...
    def __init__(self, args):
        ...
        self.meta = {
            ...
            'img_root_dir':
            '/raid/.comp/export_uint16_png_v2/',
            'fold_idx': 0,
            'num_sched_epochs': 6,
            'num_epochs': 50,
            'start_ratio': 1 / 3,
    ...
    def build_train_dataset(self):
        ...
        train_dataset = datasets._v2_test.RSNADataset(csv_path, img_root_dir,
    ...
    def build_val_dataset(self):
        ...
        val_dataset = datasets._v2_test.RSNADataset(csv_path, img_root_dir,
                                              augment_fn, transform_fn)
        return val_dataset
    ...
    def build_train_loss_fn(self):
        ...
        if self.args.jsd_loss:
            ...
            if self.args.bce_loss:
                ...
                train_loss_fn = BinaryCrossEntropy(smoothing=self.args.smoothing, target_threshold=self.args.bce_target_thresh, pos_weight=pos_weight)
            else:
                # train_loss_fn = LabelSmoothingCrossEntropy(smoothing=self.args.smoothing)
                print('Using CCE with smoothing.')
                train_loss_fn = nn.CrossEntropyLoss(weight=None, reduction='mean', label_smoothing=self.args.smoothing)
        else:
