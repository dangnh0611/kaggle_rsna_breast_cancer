...
class Exp(_BaseExp):
    ...
    def __init__(self, args):
        ...
        self.meta = {
            ...
            'img_root_dir': '/raid/.comp/rsna/uint8_voilut_png@yolox_nano_bre_416_datav2',
            'fold_idx': 0,
            'num_sched_epochs': 6,
            'num_epochs': 50,
            'start_ratio': 1 / 3,
    ...
    def build_train_dataset(self):
        ...
        train_dataset = datasets.v2.RSNADataset(
            csv_path,
            img_root_dir,
            augment_fn,
            transform_fn,
    ...
    def build_val_dataset(self):
        ...
        print('Val Transform:\n', transform_fn)
        val_dataset = datasets.v2.RSNADataset(
            csv_path,
            img_root_dir,
            augment_fn,
            transform_fn,
