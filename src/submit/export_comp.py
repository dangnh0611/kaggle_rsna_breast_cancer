...
if MODE == 'KAGGLE-VAL':
    ...
    ROI_YOLOX_ENGINE_PATH = '../roi_det/YOLOX/YOLOX_outputs/yolox_nano_bre_416/model_trt.pth'
    CSV_PATH = '/home/dangnh36/projects/.comp/rsna/datasets/train.csv'
    DCM_ROOT_DIR = '/home/dangnh36/projects/.comp/rsna/datasets/train_images'
    SAVE_IMG_ROOT_DIR = '/raid/.comp/rsna/uint8_voilut_png@yolox_nano_bre_416_datav2'
    N_CHUNKS = 1
    N_CPUS = 3  
    RM_DONE_CHUNK = False
else:
