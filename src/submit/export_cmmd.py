...
if MODE == 'KAGGLE-VAL':
    ...
    ROI_YOLOX_ENGINE_PATH = '../roi_det/YOLOX/YOLOX_outputs/yolox_nano_bre_416/model_trt.pth'
    CSV_PATH = '/home/dangnh36/projects/.comp/rsna/datasets/external/cmmd/label_v2.csv'
    DCM_ROOT_DIR = '/home/dangnh36/projects/.comp/rsna/datasets/external/cmmd/dicoms_v2'
    SAVE_IMG_ROOT_DIR = '/raid/.comp/external/cmmd/uint8_voilut_png@yolox_nano_bre_416_datav2'
    N_CHUNKS = 1
    N_CPUS = 4
    RM_DONE_CHUNK = False
else:
