...
from yolox.utils import configure_module, configure_nccl, configure_omp, get_num_devices, seed_everything
...
def main(exp: Exp, args):
    print('MODEL CHECKPOINTS WILL BE SAVED TO', exp.output_dir)
    if exp.seed is not None:
        exp.seed = int(exp.seed)
        print(f'DO SEEDING with seed={exp.seed} !')
